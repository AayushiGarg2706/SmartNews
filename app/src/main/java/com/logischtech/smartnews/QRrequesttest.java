...
public class QRrequesttest extends AppCompatActivity {

    TextView tvcastid1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_qrrequesttest);
        tvcastid1 = (TextView)findViewById(R.id.castid1);
    ...
    private class HttpQRcodeRequest extends AsyncTask<Object, Object, String> {
        private ProgressDialog progress = new ProgressDialog(QRrequesttest.this
        );
        ...
        protected void onPostExecute(String string) {
            ...
            if (string == "true"){
                Intent gotodashboard = new Intent(QRrequesttest.this,CastToDevice.class);
                startActivity(gotodashboard);

            }
            else {

                new AlertDialog.Builder(QRrequesttest.this)
